...
setTitle('TOKEN GEN | Dma Mig Om Du Behöver Flera Tools https://discord.gg/smarket');
// Libs
...
(async () => {
  ...
  console.log(' /$$__  $$| $$  /$$/| $$__  $$| $$  | $$| $$  /$$/| $$_____/| $$$ | $$'.brightGreen);
  console.log('| $$  \__/| $$ /$$/ | $$  \ $$| $$  | $$| $$ /$$/ | $$      | $$$$| $$'.brightWhite);
  console.log('|  $$$$$$ | $$$$$/  | $$$$$$$/| $$  | $$| $$$$$/  | $$$$$   | $$ $$ $$'.brightWhite);
  console.log(' \____  $$| $$  $$  | $$__  $$| $$  | $$| $$  $$  | $$__/   | $$  $$$$'.brightRed);
  console.log(' /$$  \ $$| $$\  $$ | $$  \ $$| $$  | $$| $$\  $$ | $$      | $$\  $$$'.brightRed);
  console.log('|  $$$$$$/| $$ \  $$| $$  | $$|  $$$$$$/| $$ \  $$| $$$$$$$$| $$ \  $$'.brightRed);
  console.log(' \______/ |__/  \__/|__/  |__/ \______/ |__/  \__/|________/|__/  \__/'.brightRed);
     
     console.log("TITEL : Token Gen!".brightGreen);
     console.log("Gjord Av: ! skurken#2679".brightWhite);
     console.log("Discord : https://discord.gg/smarket ".brightRed);
     console.log("Bästa Token Gen På Marknaden ! skurken#2679 ".brightRed);
